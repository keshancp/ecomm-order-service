package com.ecomm.orderservice.aop;
...
import com.ecomm.orderservice.util.CommonUtil;

@Aspect
@Component
public class LoggingAspect {

	@Pointcut("within(@org.springframework.web.bind.annotation.RestController *) || within(com.ecomm.orderservice.controller..*)")
	...
	@Pointcut("within(@org.springframework.stereotype.Service *) || within(com.ecomm.orderservice.service.impl..*)")
